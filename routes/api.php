...
Route::prefix('user')->group(function () {
    ...
    Route::group(['middleware' => ['auth:api', 'validuser']], function () {
        ...
        // user super-app home screen cells (segments, banners, restaurants, stores)
        Route::post('/main-screen', ['as' => 'api.user.main-screen', 'uses' => 'Api\MainScreenController@mainScreenSegments']);
        ...
        Route::prefix('handyman')->group(function () {
            ...
            Route::prefix('bidding')->group(function () {
                ...
                Route::post('/counter-bid-order', ['as' => 'api.handyman.bidding.driver.bid.order', 'uses' => 'Api\PlumberBiddingController@CounterbidOrder']);
        ...
        Route::prefix('laundry')->group(function () {
            Route::post('/get-categories', ['as' => 'api.user.laundry.categories', 'uses' => 'LaundryOutlet\Api\UserController@getCategories']);
            Route::post('/get-services', ['as' => 'api.user.laundry.services', 'uses' => 'LaundryOutlet\Api\UserController@getServices']);
            Route::post('/get-outlets', ['as' => 'api.user.laundry.outlets', 'uses' => 'LaundryOutlet\Api\UserController@getOutlets']);
            Route::post('/get-outlet', ['as' => 'api.user.laundry.outlet', 'uses' => 'LaundryOutlet\Api\UserController@getOutlet']);
            Route::post('/service-slots', ['as' => 'api.user.laundry.slots', 'uses' => 'LaundryOutlet\Api\UserController@serviceSlots']);
            Route::post('/save-cart', ['as' => 'api.user.laundry.save-cart', 'uses' => 'LaundryOutlet\Api\UserController@saveCart']);
            Route::post('/get-cart', ['as' => 'api.user.laundry.get-cart', 'uses' => 'LaundryOutlet\Api\UserController@getCart']);
            Route::post('/delete-cart', ['as' => 'api.user.laundry.delete-cart', 'uses' => 'LaundryOutlet\Api\UserController@deleteCart']);
            Route::post('/apply-promo', ['as' => 'api.user.laundry.apply-promo', 'uses' => 'LaundryOutlet\Api\UserController@applyPromo']);
            Route::post('/confirm-order', ['as' => 'api.user.laundry.confirm-order', 'uses' => 'LaundryOutlet\Api\UserController@confirmOrder']);
            Route::post('/get-orders', ['as' => 'api.user.laundry.orders', 'uses' => 'LaundryOutlet\Api\UserController@getOrders']);
            Route::post('/get-order-detail', ['as' => 'api.user.laundry.order-detail', 'uses' => 'LaundryOutlet\Api\UserController@getOrderDetail']);
            Route::post('/verify-otp', ['as' => 'api.user.laundry.verify-otp', 'uses' => 'LaundryOutlet\Api\UserController@verifyOtp']);
            Route::post('/cancel-order', ['as' => 'api.user.laundry.cancel-order', 'uses' => 'LaundryOutlet\Api\UserController@cancelOrder']);
            Route::post('/rate-outlet', ['as' => 'api.user.laundry.rate-outlet', 'uses' => 'LaundryOutlet\Api\UserController@rateOutlet']);
        });
        ...
        // User Bus Booking API's
        Route::prefix('bus')->group(function () {
            Route::post('/search-routes', ['as' => 'api.user.bus.search-routes', 'uses' => 'Api\BusController@searchRoutes']);
            Route::post('/route-stops', ['as' => 'api.user.bus.route-stops', 'uses' => 'Api\BusController@routeStops']);
            Route::post('/available-buses', ['as' => 'api.user.bus.available-buses', 'uses' => 'Api\BusController@availableBuses']);
            Route::post('/seat-map', ['as' => 'api.user.bus.seat-map', 'uses' => 'Api\BusController@seatMap']);
            Route::post('/checkout', ['as' => 'api.user.bus.checkout', 'uses' => 'Api\BusController@checkout']);
            Route::post('/confirm', ['as' => 'api.user.bus.confirm', 'uses' => 'Api\BusController@confirm']);
            Route::post('/bookings', ['as' => 'api.user.bus.bookings', 'uses' => 'Api\BusController@bookings']);
            Route::post('/booking-detail', ['as' => 'api.user.bus.booking-detail', 'uses' => 'Api\BusController@bookingDetail']);
            Route::post('/cancel-booking', ['as' => 'api.user.bus.cancel-booking', 'uses' => 'Api\BusController@cancelBooking']);
        });

        // User Carpooling API's
        Route::prefix('carpool')->group(function () {
            Route::post('/search-rides', ['as' => 'api.user.carpool.search-rides', 'uses' => 'Api\CarpoolingController@searchRides']);
            Route::post('/offer-ride', ['as' => 'api.user.carpool.offer-ride', 'uses' => 'Api\CarpoolingController@offerRide']);
            Route::post('/book-ride', ['as' => 'api.user.carpool.book-ride', 'uses' => 'Api\CarpoolingController@bookRide']);
            Route::post('/offer-rides', ['as' => 'api.user.carpool.offer-rides', 'uses' => 'Api\CarpoolingController@offerRides']);
            Route::post('/taken-rides', ['as' => 'api.user.carpool.taken-rides', 'uses' => 'Api\CarpoolingController@takenRides']);
            Route::post('/ride-detail', ['as' => 'api.user.carpool.ride-detail', 'uses' => 'Api\CarpoolingController@rideDetail']);
            Route::post('/cancel-ride', ['as' => 'api.user.carpool.cancel-ride', 'uses' => 'Api\CarpoolingController@cancelRide']);
            Route::post('/cancel-offer-ride', ['as' => 'api.user.carpool.cancel-offer-ride', 'uses' => 'Api\CarpoolingController@cancelOfferRide']);
        });
...
Route::prefix('business-segment')->group(function () {
    Route::group(['middleware' => ['business_segment']], function () {
        Route::get('/fastlane-configuration', ['as' => 'api.business-segment.configuration', 'uses' => 'BusinessSegment\Api\AccountController@FastLaneConfiguration']);
        Route::post('/cms/pages', ['as' => 'api.business-segment-cmspages', 'uses' => 'Api\CommonController@StoreCmsPage']);
        Route::post('/store/getString', ['as' => 'api.business-segment-getString', 'uses' => 'Api\CommonController@getStringForStore']);
        Route::post('/login-details', ['as' => 'api.business-segment-loginDetails', 'uses' => 'BusinessSegment\Api\AccountController@getLoginDetails']);
        Route::post('/configuration', ['as' => 'api.business-segment-configuration', 'uses' => 'BusinessSegment\Api\AccountController@configuration']);
        Route::post('/get-stripe-connect-required-details', ['as' => 'api.business-segment.strip-connect', 'uses' => 'BusinessSegment\Api\AccountController@getStripeConnectRequireDetails']);
        Route::post('/get-stripe-connect-require-document', ['as' => 'api.business-segment.strip-connect.document', 'uses' => 'BusinessSegment\Api\AccountController@StripeConnectRequiredDocument']);
        Route::post('/upload-stripe-connect-document', ['as' => 'api.business-segment.strip-connect.document.upload', 'uses' => 'BusinessSegment\Api\AccountController@StripeConnectUploadDocument']);
        Route::post('/register-stripe-connect', ['as' => 'api.business-segment.strip-connect', 'uses' => 'BusinessSegment\Api\AccountController@RegisterToStripeConnect']);
        // business segment login
        Route::post('/signup', ['as' => 'api.business-segment-signup', 'uses' => 'BusinessSegment\Api\AccountController@Signup']);
    ...
    Route::group(['middleware' => ['auth:business-segment-api', 'valid_business_segment']], function () {
        ...
        Route::post('/delete-account', ['as' => 'bs.business-segment-delete-account', 'uses' => 'BusinessSegment\Api\AccountController@DeleteAccount']);
        ...
        Route::post('/get-merchant-details', ['as' => 'api.business-segment-merchant', 'uses' => 'BusinessSegment\Api\AccountController@getMerchantDetails']);

        //self pickup modification
        Route::post('/accept-order', ['as' => 'bs.accept-order', 'uses' => 'BusinessSegment\Api\OrderController@acceptOrder']);
        Route::post('/deliver-order', ['as' => 'bs.deliver-order', 'uses' => 'BusinessSegment\Api\OrderController@deliverOrder']);
        //send chat message to user
        Route::post('/chat/send_message_to_user', ['as' => 'bs.chat.send_message_to_user', 'uses' => 'Api\ChatController@StoreSendMessageToUser']);
        //chat history api between store and user
        Route::post('/chat/store_and_user', ['as' => 'bs.chat.store_and_user', 'uses' => 'Api\ChatController@ChatHistoryBetweenStoreAndUser']);

        //chat list
        Route::post('/chat/list', ['as' => 'bs.chat.list', 'uses' => 'Api\ChatController@ChatList']);

        Route::post('/cards', 'BusinessSegment\Api\CardController@businessSegmentCards');
        Route::post('/save-card', 'BusinessSegment\Api\CardController@savebusinessSegmentCard');
        Route::post('/card/delete', 'BusinessSegment\Api\CardController@businessSegmentDeleteCard');
        Route::post('/card/make-payment', 'BusinessSegment\Api\CardController@businessSegmentCardPayment');

        Route::post('/wallet/addMoney', ['as' => 'api.driver.addMoney', 'uses' => 'BusinessSegment\Api\WalletTransactionController@AddMoney']);

        //merchant plan details
        Route::post('/membership-plan', ['as' => 'api.plan-details', 'uses' => 'BusinessSegment\Api\MembershipPlanController@getPlanDetails']);
        Route::post('/purchase-membership-plan', ['as' => 'api.purchase-membership', 'uses' => 'BusinessSegment\Api\MembershipPlanController@purchaseMembership']);
    });
});
