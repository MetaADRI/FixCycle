...
//            p($segment_services);
        ...
        return view('merchant.service_types.index', compact('segment_services', 'info_setting','appConfig','merchant_segment_group', 'handyman_segment_services', 'merchant_segement_group_icons', 'merchant', 'handyman_segment_creation', 'handyman_stores'));
    }
