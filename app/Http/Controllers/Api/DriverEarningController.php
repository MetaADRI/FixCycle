...
//
                    ...
                    $data[] = array(
                        ...
                        'platform' => $platform,
                        'date' => isset($value['driver_renewable_subscription_package_id'])? date('d M, D H:i a', strtotime($value['created_at'])) :date('d M, D H:i a',strtotime(convertTimeToUSERzone($value['created_at'],
