...
class ManualDispatchController extends Controller
{
    ...
    public function TestIndex(){
        $hotel = get_hotel();
        $merchant_id = $hotel->merchant_id;
        $merchant = \App\Models\Merchant::where('id',$merchant_id)->first();
        ...
        return view('hotel.manual.manual', compact('config', 'paymentmethods', 'corporates', 'countries', 'baseConfig','bookingConfig','hotel','segments'));
    }
    ...
    public function BookingDispatch(ManualDispatch $request)
    {
        ...
        $hotel_id = $hotel->id;
        $merchant_id = $hotel->merchant_id;
        $string_file = $string_file = $this->getStringFile($merchant_id);
