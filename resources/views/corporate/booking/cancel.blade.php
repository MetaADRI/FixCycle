            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    <div class="panel-actions">
                        <a href="{{route('corporate.excel.cancel')}}" data-toggle="tooltip">
...
{{--                            <th>@lang("$string_file.current_status")</th>--}}
                        ...
                        @foreach($bookings as $booking)
                            <tr>
                                ...
                                <td>
                                                        <span >
                                                            @if(isset($booking->CancelReason))
                                                                {{ $booking->CancelReason->ReasonName }}
                                                            @endif    
                                                        </span>

                                    <span >
                                        @if($booking->booking_status == 1008 && !empty($booking->corporate_ride_rejector))
                                            <span class="badge badge-info">@lang("$string_file.approver") @lang("$string_file.rejected") </span>
                                        @endif
                                    </span>
